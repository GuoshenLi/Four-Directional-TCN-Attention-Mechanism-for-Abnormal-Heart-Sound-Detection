...
if __name__ == '__main__':
    ...
    # x_train = data['features_train'][:100] / 255.
    # y_train = data['labels_train'][:100]
    #
    #
    ...
    X, X_up_1, X_down_1, X_left_1, X_right_1 = Attention_1(X, 64, training=training_flag)
    X = residual_block(X, out_channels = 128, stride = 1, training = training_flag)
    X, X_up_2, X_down_2, X_left_2, X_right_2 = Attention_2(X, 128, training=training_flag)
    X = residual_block(X, out_channels = 256, stride = 1, training = training_flag)
    X, X_up_3, X_down_3, X_left_3, X_right_3 = Attention_3(X, 256, training=training_flag)
